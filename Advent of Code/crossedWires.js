class Line {
   ...
   getIntersection(line) {
      ...
      let x = Infinity,
         y = Infinity;
      if (this.getSlope() === 0 && withinBounds(this, line)) {
         y = this.coor1[1];
         x = line.coor1[0];
      } else if (line.getSlope() === 0 && withinBounds(this, line)) {
         y = line.coor1[1];
         x = this.coor1[0];
      }
      return [x, y];
...
function withinBounds(line1, line2) {
   if (line1.getSlope() === 0) {
      return (
         line2.coor1[0] >= Math.min(line1.coor1[0], line1.coor2[0]) &&
         line2.coor1[0] <= Math.max(line1.coor1[0], line1.coor2[0]) &&
         line1.coor1[1] >= Math.min(line2.coor1[1], line2.coor2[1]) &&
         line1.coor1[1] <= Math.max(line2.coor1[1], line2.coor2[1])
      );
   } else if (line2.getSlope() === 0) {
      return (
         line1.coor1[0] >= Math.min(line2.coor1[0], line2.coor2[0]) &&
         line1.coor1[0] <= Math.max(line2.coor1[0], line2.coor2[0]) &&
         line2.coor1[1] >= Math.min(line1.coor1[1], line1.coor2[1]) &&
         line2.coor1[1] <= Math.max(line1.coor1[1], line1.coor2[1])
      );
   }
}
